...
def api_caller(q,f,z):
    ...
    while not q.empty():
        ...
        try:
            ...
            long=cordinate_formatter(element.get('longitude'))
            lat=cordinate_formatter(element.get('latitude'))
...
#             time.sleep(60)
#         for i in range(5):
#             worker = threading.Thread(target=api_caller, args=(q, f, z,))
#             worker.start()
